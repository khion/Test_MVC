...
namespace Assignment_MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,EmployeeID,ServiceID,Name,Email")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,EmployeeID,ServiceID,Name,Email")] Employee employee)
        {
            if (ModelState.IsValid)
            {
